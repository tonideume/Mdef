...
<!-- Columna de texto -->
 ...
 The concept consist on create an machine that searches the perfect conditions for a microecosistem of his own. It moves because urban hostility is not static. Heat, shade, dryness, and exposure shift constantly in the city and most non-human species lack the ability to escape them. Mobility becomes a survival strategy.      </p>
    </div>
...
<!-- Columna de texto -->
   <div class="columna columna-texto">
        <p> <span class="texto-especial">3-Assembling
         the structure</span>. 
...
<!-- Columna de texto -->
   <div class="columna columna-texto">
        <p> <span class="texto-especial">4-The terrarium</span>. 
